...
function CertificateComponent({ student, studentId, date, course, onImageGenerate }) {
    ...
    return (
        <div id="certificate-container" className="p-2 rounded shadow-lg relative overflow-hidden text-center" style={{ backgroundColor: '#001741', display: 'none', borderStyle: 'solid', borderWidth: '15px', borderImage: 'linear-gradient(45deg, rgb(1,65,188), rgb(63,229,245)) 1' }}>
                    ...
                    <div id="certificate-padding3" className="border-l border-r border-dashed" style={{ borderColor: '#FF00E2', padding: '0px 4px', backgroundColor: '#001741' }}>
                        <div id="certificate-padding4" className="border-t border-b" style={{ borderImage: 'linear-gradient(15deg, rgb(1,65,188), rgb(255,0,226)) 1', padding: '4px', background: '#001741 linear-gradient(hsla(184, 96%, 46%, 0) 90%,hsla(184, 96%, 46%, 0.2) 95%)top left / 100% 0.4rem' }}>
                            <div id="certificate" className="px-10" style={{ textAlign: 'center', fontFamily: 'Tahoma' }}>
                                ...
                                <div className="py-1 my-10 mx-auto" style={{ borderTop: '15px solid', borderBottom: '10px solid', maxWidth: '1200px', borderImage: 'linear-gradient(15deg, rgb(1,65,188), rgb(63,229,245)) 1', clipPath: 'polygon(0px 10px, 26px 0px, calc(30% - 25px) 0px, 30% 10px, 100% 10px, 100% calc(100% - 5px), calc(100% - 10px) calc(100% - 5px), calc(70% - 5px) calc(100% - 5px), calc(70% - 10px) calc(100% - 0px), 5px calc(100% - 0px), 0% calc(100% - 5px))' }}>
                                    <div className="border-t border-b" style={{ borderImage: 'linear-gradient(15deg, rgb(63,229,245), rgb(255,255,255)) 1' }}>
                                        <h1 className="my-7 text-2xl font-bold" style={{ color: '#4DE6EE', textTransform: 'uppercase' }}>Certificate of Completion</h1>
                                    </div>
                                </div>
                                <p className="mb-7" style={{ color: 'white' }}>This is to certify that</p>
                                <p className="text-6xl font-bold mb-1" style={{ color: '#4DE6EE', textTransform: 'uppercase', textShadow: '2px 0px white' }}>{student}</p>
                                <p className="text-lg mb-7 font-bold" style={{ color: '#4DE6EE', textShadow: '1px 0px white' }}>Student ID: {studentId}</p>
                                <p className="" style={{ color: 'white' }}>Has successfully completed the course</p>
                                <p className="text-xl font-bold mb-4" style={{ color: 'white' }}>{course}</p>
                                <p className="mb-10" style={{ color: 'white' }}>Awarded this {date}</p>
                            </div>
                        </div>
                    </div>
                </div>
